...
// clang-format off
namespace offsets {
    inline constexpr const char* roblox_version = "version-145f189a6a974303";
    ...
    namespace Lighting {
        ...
        inline constexpr uintptr_t Atmosphere = 0x1D0;
    ...
    namespace LightingParameters {
        ...
        inline constexpr uintptr_t SkyAmbient = 0x148;
        inline constexpr uintptr_t SkyAmbient2 = 0x138;
        inline constexpr uintptr_t Source = 0x16C;
        inline constexpr uintptr_t TrueMoonPosition = 0x17C;
        inline constexpr uintptr_t TrueSunPosition = 0x170;
    }
    ...
    namespace TextButton {
        ...
        inline constexpr uintptr_t Font = 0x1130;
    ...
    namespace TextLabel {
        ...
        inline constexpr uintptr_t Font = 0xEB0;
    ...
    namespace World {
        ...
        inline constexpr uintptr_t WorldSteps = 0x700;
    }
